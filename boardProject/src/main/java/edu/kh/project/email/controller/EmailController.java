...
public class EmailController {
	...
	// 레디스 확인하기
	@ResponseBody
	@GetMapping("redisTest") // 레디스 적용 확인 : 주소창에 localhost/email/redisTest?key=name&value=홍길동 검색 -> 1 확인 후->  C:\Program Files\Redis\redis-cli 에서 keys *, get name 입력 (value 한글은 깨짐)
