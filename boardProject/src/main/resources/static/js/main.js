    ...
    list.forEach(member => {
      ...
      if (member.memberDelFl == 'Y'){
        ...
        loginBtn.addEventListener("click", ()=>{
          ...
          // 제출하는 형식으로 코드 작성(form / AJAX만 POST 방식 요청 가능)
          ...
          form.append(input); // 만들어진 form 태그의 자식으로 input 추가

          // body 태그의 자식으로 form 추가
        ...
        initBtn.addEventListener("click", () => {
          ...
          .then(result => {
            if(result > 0 ) { 
              ...
              alert("비밀번호 초기화에 실패했습니다. 다시 시도해 주세요.");
            }
          })
